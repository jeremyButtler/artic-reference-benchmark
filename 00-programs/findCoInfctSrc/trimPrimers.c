...
#    -end-trim:
#      o Only trim of the primers at the ends
#    -v:
...
char * checkInput(
    ...
    char *styleC,         /*Holds if trimming end primers*/
...
{ /*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\
  ...
  \~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    ...
    char styleC = 0;
      /*0: Trim every primer out;
      ` 1: trim only primers at the end
      */
    ...
    char *helpMesgCStr = "\
        ...
        \n     o Fastq file to filter reads from\
        \n   -end-trim:                                      [No]\
        \n     o Only trim primers off ends of each read.\
        \n   -no-hash:                                       [Hashing]\
...
char * checkInput(
   ...
   \~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    ...
    { /*loop through all user input arguments*/  /*0 is program name*/
        ...
        else if(strcmp(tmpCStr, "-end-trim") == 0)
        { /*Else if only trimming of the ending primers*/
            *styleC = 1;
            --intArg;
        } /*Else if only trimming of the ending primers*/
